...
namespace Dance.Wpf
{
    ...
    /// polyline 元素
    /// </summary>
    public class DancePolyline : DanceSVGDrawingElement
    {
        /// <summary>
        /// polyline 元素
        /// </summary>
        ...
        public DancePolyline(DanceSVG? svg, DanceSVGElement? parent, XElement? element) : base(svg, parent, element)
        {
        ...
        {
            return new DancePolyline(this.SVG, this.Parent, this.Element);
        }
