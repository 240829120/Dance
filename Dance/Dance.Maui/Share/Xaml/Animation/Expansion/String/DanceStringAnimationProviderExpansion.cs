...
namespace Dance.Maui
{
    ...
    public static class DanceStringAnimationProviderExpansion
    {
        ...
        /// 处理器
        /// </summary>
        private readonly static DanceAnimationDiscreteProvider<string> Provider = new();
        ...
        public static IDanceAnimationBuilder String(this IDanceAnimationBuilder builder, BindableProperty property, Easing? easing, params DanceAnimationKeyFrame<string>[] keyFrames)
        {
