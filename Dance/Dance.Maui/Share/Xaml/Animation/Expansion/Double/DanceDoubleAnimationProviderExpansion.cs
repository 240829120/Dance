...
namespace Dance.Maui
{
    ...
    public static class DanceDoubleAnimationProviderExpansion
    {
        ...
        /// 处理器
        /// </summary>
        private readonly static DanceDoubleAnimationProvider Provider = new();
        ...
        public static IDanceAnimationBuilder Double(this IDanceAnimationBuilder builder, BindableProperty property, Easing? easing, params DanceAnimationKeyFrame<double>[] keyFrames)
        {
