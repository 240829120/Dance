...
namespace Dance.Maui
{
    ...
    public abstract class DanceNavigationSwitchProviderBase
    {
        ...
        protected abstract void ExecuteIn(int inIndex, int? outIndex, DanceNavigationView navigation, DanceNavigationItem view, Easing easing, TimeSpan duration);
        ...
        /// <param name="easing">过渡函数</param>
        /// <param name="duration">持续时间</param>
        protected abstract void ExecuteOut(int? inIndex, int outIndex, DanceNavigationView navigation, DanceNavigationItem view, Easing easing, TimeSpan duration);
