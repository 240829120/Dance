...
namespace Dance.Maui
{
    ...
    public class DanceParticleControllerBox : DanceParticleControllerBase
    {
        ...
        public static readonly BindableProperty XProperty =
            BindableProperty.Create(nameof(X), typeof(DanceRangeFloat), typeof(DanceParticleControllerBox), new DanceRangeFloat(10, 20));
        ...
        public static readonly BindableProperty YProperty =
            BindableProperty.Create(nameof(Y), typeof(DanceRangeFloat), typeof(DanceParticleControllerBox), new DanceRangeFloat(10, 20));
        ...
        /// Y取值范围
        /// </summary>
        public static readonly BindableProperty ZProperty =
            BindableProperty.Create(nameof(Z), typeof(DanceRangeFloat), typeof(DanceParticleControllerBox), new DanceRangeFloat(10, 20));
